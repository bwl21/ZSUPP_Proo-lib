...
#  typesig(Traceable)
  ...
  # expose added traceables
  # @param @reference_set - the set of traceables used as reference
  # @return [String] list of trace_id which are not in @referece_set
  ...
  # this returns a particlar trace
  ...
  # @param [String] slot to be cached
  # @param [String] name of the cachefile
  ...
  # @param [String] slot to be filled
  # @param [String] name of the cachefile
